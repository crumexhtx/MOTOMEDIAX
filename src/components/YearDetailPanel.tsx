            ...
            {trims.map((t) => {
              ...
              return (
                <button
                  ...
                  className={
                    active
                      ? "rounded-md border border-accent bg-[var(--accent-soft)] px-3 py-1.5 text-sm"
                      : "rounded-md border border-line bg-elevated/50 px-3 py-1.5 text-sm text-muted transition hover:border-accent/50 hover:text-foreground"
                  }
                >
                  {t.name}
                </button>
